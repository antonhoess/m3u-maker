...
Dim Liste As String, I As Integer, Pfad As String, Löschcount As Integer, DName As String, PathAbs As Boolean
...
Private Sub CmdSelAdd_Click()
    ...
    Löschcount = LstFilesSrc.ListCount
...
Private Sub CmdSelRem_Click()
    On Error Resume Next
    Löschcount = LstFilesDst.ListCount
    For I = 0 To Löschcount - 1
        If LstFilesDst.Selected(Löschcount - I - 1) = True Then LstFilesDst.RemoveItem (Löschcount - I - 1)
    Next I
End Sub
